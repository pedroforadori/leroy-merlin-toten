        ...
        {products.map(product => (
          ...
          >
            ...
            <BoxDecription>
              ...
              <PriceProduct> R$ <span>{ currencyDisplay(product.prices || 18.9, false).split(',')[0] }</span><span>,{ currencyDisplay(product.prices || 18.9, false).split(',')[1] }</span><span>cada</span> </PriceProduct>
